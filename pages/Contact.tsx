            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
                    ...
                    <div>
                        ...
                        <h1 className="text-5xl font-bold font-serif mb-8">Connect with Our Advisors</h1>
                    ...
                    {/* Form Side */}
                    <div className="bg-neutral-950 border border-white/10 p-8 md:p-10 relative overflow-hidden">
