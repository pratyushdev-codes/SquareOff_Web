        ...
        <div className="pt-24 bg-black text-white min-h-screen">
            ...
            <div className="max-w-[1800px] mx-auto px-6 lg:px-8 py-16 md:py-24">
                ...
                >
                    ...
                    <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl md:text-8xl xl:text-9xl 2xl:text-[10rem] font-bold font-serif mb-8 text-white leading-tight">
                        The India <br /> Opportunity.
                    </motion.h1>
                    <motion.p variants={fadeInUp} className="text-lg sm:text-xl md:text-2xl xl:text-2xl text-neutral-400 leading-relaxed font-light max-w-3xl xl:max-w-4xl border-l border-white/20 pl-6">
