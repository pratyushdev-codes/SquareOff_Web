      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white text-black p-10 md:p-14 relative overflow-hidden group">
              <div className="relative z-10">
                <h3 className="text-sm font-bold uppercase tracking-widest mb-4 opacity-60">Our Mission</h3>
                <h4 className="text-3xl font-serif font-bold mb-6">Where Smart Money Begins.</h4>
            ...
            <div className="bg-neutral-900 text-white p-10 md:p-14 border border-white/10 relative overflow-hidden group">
              <div className="relative z-10">
                <h3 className="text-sm font-bold uppercase tracking-widest mb-4 text-neutral-400">Our Vision</h3>
                <h4 className="text-3xl font-serif font-bold mb-6">Global Leadership.</h4>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-2 lg:order-1">
              <div className="mb-12">
                <h2 className="text-4xl md:text-5xl font-serif font-bold mb-2">Varun Pandya</h2>
