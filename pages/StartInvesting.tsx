  ...
  return (
    <div className="pt-24 bg-black text-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 text-center">
        ...
        >
          <motion.h1 variants={fadeInUp} className="text-5xl md:text-7xl font-bold font-serif mb-6">
            Begin Your <br /> Wealth Journey
          </motion.h1>
          <motion.p variants={fadeInUp} className="text-xl text-neutral-400 mb-8 max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="py-24 bg-white text-black">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6">Need a personalized roadmap?</h2>
            ...
            <div className="relative h-[400px] bg-neutral-100 p-8 flex items-center justify-center border border-black/10">
